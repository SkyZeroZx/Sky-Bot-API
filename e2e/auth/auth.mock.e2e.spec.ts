...
import { UserResetPasswordDto } from '../../src/auth/dtos/user-reset-password.dto';
...
export class AuthMockServiceE2E {
  ...
  public static readonly userResetado: User = {
    ...
    status: Constants.STATUS_USER.RESET,
    firstLogin: false,
  ...
  public static readonly resetUserDto: UserResetPasswordDto = {
    username: 'SkyZeroZx',
  };
